...
public class ScreenLocker : MonoSingleton<ScreenLocker>
{
	...
	public class Option
	{
		...
		public static Option None = new Option() { FullModal = true, FilterColor = Color.clear };
		public static Option Modal = new Option() { FilterColor = new Color(0, 0, 0, 0.75f) };
	}
	...
	public static void Unmodal(GameObject dummy = null /* TODO: そのうち使う */)
	{
		Instance.DoUnmodal();
	}
